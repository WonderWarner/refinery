...
// Problem defined for MOEA to handle a Refinery model
public class RefineryProblem extends AbstractProblem {

	public static final int DEFAULT_RANDOMIZE_DEPTH = 1;
	private static final int VERSION_VARIABLE_INDEX = 0;	//There is only one variable -> The model version itself
	...
	VisualizationStore getVisualizationStore() { return visualizationStore; }
